...
// MARK: - Response
public struct StandingResponse: Codable, Sendable, Identifiable {
    public var id: Int { league.id }
...
// MARK: - All
public struct AllPoints: Codable, Sendable {
...
func dummyLeagueStandingResponse()->LeagueStandingsResponse{
...
"""
    ...
    do {
        ...
        let data:LeagueStandingsResponse? =  try? jsonString.toObject()
